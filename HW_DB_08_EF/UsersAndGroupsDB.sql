...
/****** Object:  Database [UsersAndGroups]    Script Date: 21.7.2013 г. 01:45:48 ч. ******/
CREATE DATABASE [UsersAndGroups]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'UsersAndGroups', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\UsersAndGroups.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'UsersAndGroups_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\UsersAndGroups_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
