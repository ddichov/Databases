...
namespace SQLite_Connection
{
    class Program
    {
        static void Main()
        {
            SQLiteConnection connection = new SQLiteConnection(@"Data Source=D:\User Files\My Documents\Telerik Academy\CSharpTrack\06 Databases\Homework\DB HW 07 ADO\SQLite Connection\Library.db;Version=3;");
            AddBook(5, "JS UI", "Doncho", 2013, "911-22-11", connection);
